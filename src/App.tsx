...
function App() {
  ...
  return (
    <div className="flex items-start justify-center bg-[#353535]">
      ...
      {/* Right Section */}
      <div className="w-[370px] min-h-[257px] m-[20px] p-5 bg-[#292929] rounded-md">
        <div className="text-[24px] mb-[24px]">Your Cart ({getTotalItems()})</div>
          ...
          <div className="flex flex-col">
            {cartItems.map((item, index) => (
              <div key={index} className="flex justify-between mb-2">
                ...
                <button
                  className="flex items-center justify-center p-0 m-0 bg-[#292929] border-none outline-none hover:bg-none focus:outline-none"
